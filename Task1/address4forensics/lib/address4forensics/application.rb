  ...
  class Application
    ...
    def parse_options(argv)
      ...
      opt_parser = OptionParser.new do |opts|
        ...
        opts.on("-L", "--logical", "Calculate the logical address",
        ...
        opts.on("-P", '--physical', 'Calculate the physical ','
        ...
        opts.on("-C", '--cluster', 'Calculate the cluster address ','
        ...
        opts.on("-b", "--partition-start offset", Integer , 'This specifies the ','
        ...
        opts.on("-B", "--byte-address", 'Instead of returning ','
        ...
        opts.on("-l", "--logical-known address", Integer, 'This specifies the ','
        ...
        opts.on("-p", "--physical-known address", Integer, 'This specifies the ','
        ...
        opts.on("-c", "--cluster-known address", Integer, 'This specifies the ','
